...
hinting, to ensure consistency in the codebase and avoid repeating discussions about how we apply typing.
...
between type aliases and ordinary assignments:
...
When used in a line by itself at the top of a file, it silences all errors in the file:
