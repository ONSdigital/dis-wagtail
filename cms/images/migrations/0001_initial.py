    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    wagtail.images.models.WagtailImageField(height_field="height", width_field="width"),
                ),
                ...
                (
                    "tags",
                    taggit.managers.TaggableManager(blank=True, through="taggit.TaggedItem", to="taggit.Tag"),
                ),
                (
                    "uploaded_by_user",
                    models.ForeignKey(
