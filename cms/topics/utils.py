...
class ArticleProcessor:
    ...
    def _get_manual_articles(self) -> tuple[list[dict], list[int]]:
        ...
        for related in self.topic_page.related_articles.select_related("page").all():
            ...
            if article:
                ...
                if "internal_page" in article:
                    highlighted_page_pks.append(article["internal_page"].pk)

        return manual_articles, highlighted_page_pks

    def _process_related_article(self, related: "TopicPageRelatedArticle") -> dict | None:
    ...
    def _get_automatic_articles(self, excluded_pks: list[int], limit: int) -> list[dict]:
