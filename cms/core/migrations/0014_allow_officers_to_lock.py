...
def add_publishing_officers_lock_permission(apps, schema_editor):
    ...
    permission = Permission.objects.get(codename="lock_page")
...
def remove_publishing_officers_lock_permission(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0013_allow_officers_to_publish"),
    ]

    operations = [
        migrations.RunPython(add_publishing_officers_lock_permission, remove_publishing_officers_lock_permission),
    ]
