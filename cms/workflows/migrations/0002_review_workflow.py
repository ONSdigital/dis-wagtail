...
def create_tasks_and_workflow(apps, schema_editor):
    ...
    review_task = GroupReviewTask.objects.create(name="Preview", content_type=review_task_content_type, active=True)
    ...
    WorkflowTask.objects.create(workflow=workflow, task=ready_to_publish_task, sort_order=0)
