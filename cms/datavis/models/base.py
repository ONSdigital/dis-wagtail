...
class Visualisation(
    ...
    preview_template = "templates/datavis/preview.html"
    ...
    def get_template(self, request: "HttpRequest", **kwargs: Any) -> str:
    ...
    def get_context(self, request: "HttpRequest", **kwargs: Any) -> dict[str, Any]:
        context = {
    ...
    type_label.short_description = _("Type")
    type_label.admin_order_field = "content_type__model"
