...
def create_cookies_page(apps, schema_editor):
    ...
    CookiesPage.objects.create(
        ...
        url_path=f"{welsh_home_page.url_path}{settings.ONS_COOKIES_PAGE_SLUG}/",
        locale=welsh_locale,
