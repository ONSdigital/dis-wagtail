...
from cms.standard_pages.utils import DEFAULT_COOKIES_PAGE_URL, get_cookies_page_url
...
class UtilsTestCase(TestCase):
    ...
    def test_get_cookies_page_url_english(self):
        ...
        self.assertEqual(cookies_page_url, DEFAULT_COOKIES_PAGE_URL)

    @override_settings(CMS_USE_SUBDOMAIN_LOCALES=False)
    def test_get_cookies_page_url_welsh(self):
        cookies_page_url = get_cookies_page_url("cy")
        self.assertEqual(cookies_page_url, f"/cy{DEFAULT_COOKIES_PAGE_URL}")
