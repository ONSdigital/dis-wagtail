Feature: Statistical Article Page components
    ...
    Scenario: A CMS user can create Statistical Article Page
        ...
        Then the statistical article page preview contains the populated data
    ...
    Scenario: A CMS user can add a table on a Statistical Article Page
        ...
        And  the user clicks the "Save draft" button
        And  the user views the statistical article page draft
    ...
    Scenario: Corrections are saved in chronological order
        ...
        And the statistical article page goes through the publishing steps with superuser as user and Publishing Officer as reviewer
